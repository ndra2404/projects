...
class ModelVerticalmenuWidget extends Model {		
	...
	protected function getLayout( $layout ){
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/pavverticalmenu/widgets/'.$layout.'.tpl')) {
			$template = DIR_TEMPLATE.$this->config->get('config_template') . '/template/module/pavverticalmenu/widgets/'.$layout.'.tpl';
		} else {
