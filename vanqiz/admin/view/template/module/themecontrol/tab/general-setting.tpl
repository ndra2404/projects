	...
	<div class="tab-inner ">
		...
		<div class="form-group">
			...
			<label class="col-sm-2 control-label"><?php echo $olang->get('entry_enable_footer_center');?></label>
			<div class="col-sm-10">
				 <select class="form-control" name="themecontrol[enable_footer_center]">
					<option value="0" <?php if( $module['enable_footer_center'] == 0 ){ echo 'selected="selected"';} ;?>><?php echo $olang->get('no');?></option>
					<option value="1" <?php if( $module['enable_footer_center'] == 1 ){ echo 'selected="selected"';} ;?>><?php echo $olang->get('yes');?></option>
				</select>
			</div>
		</div>
