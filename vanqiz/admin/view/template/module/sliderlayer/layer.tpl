	...
	<div class="page-header">
		<div class="container-fluid">
			<div class="pull-right">
				<a class="btn btn-primary" onclick="$('#slider-form').submit();" class="button"><?php echo $button_save; ?></a>
      			<a class="btn btn-danger" href="<?php echo $cancel; ?>" class="button"><?php echo $button_cancel; ?></a>
      			<a class="btn btn-success" id="btn-preview-ingroup" href="<?php echo  $objurl->link('module/pavsliderlayer/previewGroup', 'id='.$group_id.'&lang='.$lang.'&token=' . $objsession->data['token'], 'SSL');?>" class="button green" id="preview"><?php echo $objlang->get('Preview Sliders In Group');?></a>
			</div>
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<h3><?php echo $objlang->get('List Of Sliders In Group');?>: <a href="<?php echo  $objurl->link('module/pavsliderlayer', 'id='.$group_id.'&token=' . $objsession->data['token'], 'SSL');?>"><span><?php echo $sliderGroup['title'];?></span></a></h3>
	    	 	<div>
					<p class="explain"><?php echo $objlang->get('drap and drop to sort slider in list');?></p>
	    	 	</div>
