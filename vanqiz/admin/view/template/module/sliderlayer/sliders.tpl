		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<ul id="grouptabs" class="nav nav-tabs" role="tablist">
					<li class="active"><a href="#tab-listmodules" role="tab" data-toggle="tab"><?php echo $objlang->get('tab_manage_module');?></a></li>
					<li><a href="#tab-slidergroups" role="tab" data-toggle="tab"><?php echo $objlang->get('tab_manage_slider_group'); ?></a></li>
					<li><a href="#tab-importtools" role="tab" data-toggle="tab"><?php echo $objlang->get('tab_import_tools');?></a></li>
				</ul>
					...
					<div class="tab-pane" id="tab-slidergroups">
						...
						<div class="groups">
							...
							<ul>
								...
								<li>    
									<a <?php if( $sgroup['id'] == $id ) { ?> class="active" <?php } ?> href="<?php echo $objurl->link('module/pavsliderlayer', 'id='.$sgroup['id'].'&token=' . $objsession->data['token'], 'SSL');?>"><?php echo $sgroup['title'];?>
						...
						<div class="group-form">
							<h4>
								...
								<?php } else { ?><?php echo $objlang->get('Create New');?><?php } ?>
							</h4>
							<table class="table">
								<tr>
									...
									<td>
										<?php if( $id ) { ?> 
										<div class="buttons">
											<a class="btn btn-success btn-sm" id="btn-preview-ingroup" href="<?php echo  $objurl->link('module/pavsliderlayer/previewGroup', 'id='.$id.'&token=' . $objsession->data['token'], 'SSL');?>" class="button grey" id="preview"><?php echo $objlang->get('Preview Sliders In Group');?></a>
											<a class="btn btn-primary btn-sm" href="<?php echo  $objurl->link('module/pavsliderlayer/layer', 'group_id='.$id.'&token=' . $objsession->data['token'], 'SSL');?>" class="btn btn-green" id="preview-sliders"><?php echo 'Manages Sliders'; ?></a>
											<a class="btn btn-danger btn-sm" href="<?php echo  $objurl->link('module/pavsliderlayer/deleteGroup', 'id='.$id.'&token=' . $objsession->data['token'], 'SSL');?>" onclick="return confirm('Are you sure to delete this');" class="btn " id="preview-sliders"><?php echo 'Delete'; ?></a>
											<a class="btn btn-warning btn-sm" href="<?php echo  $objurl->link('module/pavsliderlayer/export', 'id='.$id.'&token=' . $objsession->data['token'], 'SSL');?>"  class="btn orange" id="preview-sliders"><?php echo $objlang->get('Export Group And Sliders'); ?></a>
										</div>  
										<?php } ?>
									</td>   
								<tr>
