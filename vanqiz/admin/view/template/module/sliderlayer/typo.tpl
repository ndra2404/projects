			...
			<div class="typos">
				...
				<div class="typos-wrap">	
					<?php foreach( $captions as $caption ) {  ?>
			  		<div style="cursor: pointer;" class="typo" data-dismiss="modal"><div class="tp-caption <?php echo $caption;?>" data-class="<?php echo $caption;?>">Use This Caption Typo</div></div><br>
			  		<?php } ?>	
				 </div>
			</div>
			<!-- END CONTENT TYPOS -->
