	 	...
	 	/**
	  	...
	  	function createBannerWidget( col, img , preview, ilink ){
				...
				banner.html( "<div class=\"w-inner\">"+html+input+"</div>" );
			 	...
			 	banner.append('<div class="wpo-wedit ptstooltip" data-toggle="tooltip" data-placement="top" title="Edit"></div><div class="wpo-wdelete ptstooltip" data-toggle="tooltip" data-placement="top" title="Delete"></div>');
